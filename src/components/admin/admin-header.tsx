...
export function AdminHeader({ onProfileClick }: AdminHeaderProps) {
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-10 w-10 rounded-full">
                <Avatar className="h-10 w-10 border-2 border-border">
                  ...
                  />
                  <AvatarFallback className="text-sm font-semibold bg-gradient-to-br from-red-500 to-orange-600 text-white">
