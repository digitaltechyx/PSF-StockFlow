...
// FBA/WFS/TFS: 8 rows (4 packages × 2 product types)
...
// FBM: 8 rows (4 packages × 2 product types)
...
export function PricingManagement({ users }: PricingManagementProps) {
  ...
  useEffect(() => {
    ...
    // FBA/WFS/TFS service: 8 rows (4 packages × 2 product types)
    ...
    // FBM service: 8 rows (4 packages × 2 product types)
